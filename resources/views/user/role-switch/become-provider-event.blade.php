@extends('layouts.app')
@section('title', 'Daftar Sebagai Penjual Event — INFOMA')
    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="px-8 py-8">
                <div class="bg-orange-50 border border-orange-200 rounded-xl p-5 mb-6">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h3 class="font-semibold text-orange-800 mb-2">Status Pengajuan Penjual Event</h3>
        ...
        <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
            ...
            <div class="px-8 py-8">
                ...
                @include('user.role-switch._provider-form', [
                    'action'      => route('role.switch.become.provider_event.submit'),
                    'submitLabel' => 'Kirim Ulang Pengajuan Penjual Event',
                ])
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
            <div class="bg-gradient-to-r from-purple-600 to-purple-700 px-8 py-10 text-center">
                ...
                <h1 class="text-3xl font-bold text-white mb-2">Daftar sebagai Penjual Event</h1>
                <p class="text-purple-100">Verifikasi identitasmu untuk mulai menjual tiket & event</p>
            </div>
            <div class="px-8 py-8">
                <div class="grid grid-cols-3 gap-3 mb-8">
                    <div class="text-center p-3 bg-purple-50 rounded-xl">
                        <i class="fas fa-ticket-alt text-purple-500 text-xl mb-1 block"></i>
                        <p class="text-xs text-gray-600 font-medium">Jual Tiket</p>
                    </div>
                    ...
                    <div class="text-center p-3 bg-blue-50 rounded-xl">
                        ...
                        <p class="text-xs text-gray-600 font-medium">Laporan Lengkap</p>
                    </div>
                </div>
                <div class="border-t border-gray-100 mb-6"></div>
                @include('user.role-switch._provider-form', [
                    'action'      => route('role.switch.become.provider_event.submit'),
                    'submitLabel' => 'Kirim Pengajuan Penjual Event',
                ])
            </div>
        </div>
        @endif
