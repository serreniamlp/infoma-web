...
@section('title', 'Dashboard - Provider Hunian')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="bg-white rounded-xl shadow-sm p-6">
                    ...
                    <div class="space-y-4">
                        <a href="{{ route('provider.residence.residences.create') }}"
                            ...
                            <div class="ml-4">
                                <h4 class="font-semibold">Tambah Hunian</h4>
                                <p class="text-blue-100 text-sm">Buat hunian baru</p>
                            </div>
                        </a>
                        ...
                        <a href="{{ route('provider.residence.residences.index') }}"
                            class="flex items-center p-4 bg-gradient-to-r from-indigo-500 to-indigo-600 rounded-xl text-white hover:from-indigo-600 hover:to-indigo-700 transition-all duration-200 group">
                            <div class="bg-white/20 rounded-lg p-2 group-hover:bg-white/30 transition-colors">
                                <i class="fas fa-building text-white text-lg"></i>
                            </div>
                            <div class="ml-4">
                                <h4 class="font-semibold">Hunian Saya</h4>
                                <p class="text-indigo-100 text-sm">Kelola daftar hunian</p>
                            </div>
                        </a>
                    </div>
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                            ...
                            <div class="flex items-center space-x-3">
                                ...
                                <a href="{{ route('provider.residence.bookings.show', $booking) }}"
            ...
            <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                <div class="p-6 border-b border-gray-200">
                    <div class="flex items-center justify-between">
                        <h3 class="text-lg font-semibold text-gray-900">Hunian Terbaru</h3>
                        <a href="{{ route('provider.residence.residences.index') }}"
                            class="text-blue-600 hover:text-blue-700 text-sm font-medium flex items-center">
                            Lihat semua <i class="fas fa-arrow-right ml-1 text-xs"></i>
                        </a>
                ...
                <div class="p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                            ...
                            <div class="flex items-center space-x-3">
                                <span class="px-3 py-1 rounded-full text-xs font-medium {{ $item->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                                    {{ $item->is_active ? 'Aktif' : 'Tidak Aktif' }}
                                </span>
                                <a href="{{ route('provider.residence.residences.show', $item) }}"
                                    class="text-blue-600 hover:text-blue-700 p-1">
                                    <i class="fas fa-eye"></i>
                                </a>
                            </div>
                    ...
                    <div class="text-center py-12">
                        ...
                        <p class="text-gray-600 font-medium">Belum ada hunian</p>
                        <a href="{{ route('provider.residence.residences.create') }}"
                            class="block text-blue-600 hover:text-blue-700 text-sm font-medium mt-4">
                            Tambah hunian pertama →
                        </a>
                    </div>
                    @endif
                </div>
        ...
        <script>
        fetch('{{ route("provider.residence.dashboard.charts") }}')
