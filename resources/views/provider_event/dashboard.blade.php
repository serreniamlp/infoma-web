...
<div class="min-h-screen bg-gray-50 py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="bg-white rounded-xl shadow-sm p-6">
                    ...
                    <div class="space-y-4">
                        <a href="{{ route('provider.event.activities.create') }}"
                            ...
                            <div class="ml-4">
                                <h4 class="font-semibold">Tambah Event</h4>
                                <p class="text-green-100 text-sm">Buat event baru</p>
                            </div>
                        </a>
                        ...
                        <a href="{{ route('provider.event.activities.index') }}"
                            ...
                            <div class="ml-4">
                                <h4 class="font-semibold">Event Saya</h4>
                                <p class="text-indigo-100 text-sm">Kelola daftar event</p>
                            </div>
                        </a>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                            ...
                            <div class="flex items-center space-x-3">
                                ...
                                <a href="{{ route('provider.event.activities.show', $item) }}"
                                    class="text-blue-600 hover:text-blue-700 p-1">
                                    <i class="fas fa-eye"></i>
                                </a>
                            </div>
                    ...
                    <div class="text-center py-12">
                        ...
                        <p class="text-gray-600 font-medium">Belum ada event</p>
                        <a href="{{ route('provider.event.activities.create') }}"
        ...
        <script>
        fetch('{{ route("provider.event.dashboard.charts") }}')
