@extends('layouts.app')
@section('title', 'Laporan Pendapatan — Provider Event')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-5">
                ...
                <p class="text-xs text-gray-400 mt-1">{{ $summary['approved_bookings'] + $summary['completed_bookings'] }} dari {{ $summary['total_bookings'] }}</p>
            </div>
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-5">
                <div class="flex items-center gap-3 mb-3">
                    ...
                    <p class="text-sm font-medium text-gray-500">Rata-rata Tiket</p>
                </div>
                @php
                ...
                <p class="text-xs text-gray-400 mt-2">per pendaftaran selesai</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-6 print:hidden">
            <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xs text-gray-400 mt-0.5">Pendapatan dari pendaftaran yang selesai per hari</p>
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6 print:hidden">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100">
                    <h3 class="font-semibold text-gray-900">Komposisi Pendaftaran</h3>
                    <p class="text-xs text-gray-400 mt-0.5">Distribusi status pendaftaran</p>
                </div>
                <div class="p-6">
                        ...
                        <div class="mt-4 space-y-2">
                            @php
                                $statusData = [
                                    ...
                                    ['label' => 'Aktif',     'value' => $summary['approved_bookings'],  'color' => 'bg-purple-500'],
            ...
            <div class="lg:col-span-2 bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100">
                    <h3 class="font-semibold text-gray-900">Performa per Event</h3>
                    <p class="text-xs text-gray-400 mt-0.5">Revenue dan jumlah pendaftaran per event</p>
                </div>
                <div class="divide-y divide-gray-50">
                        ...
                        <div class="flex items-center justify-between mb-2">
                            <div class="flex items-center gap-3 min-w-0">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="text-xs text-gray-400">{{ $item->booking_count }} pendaftaran</p>
                                </div>
                            </div>
                    ...
                    <div class="px-6 py-12 text-center text-gray-400">
                        ...
                        <p class="text-sm">Belum ada data pendapatan per event</p>
                    </div>
                    @endforelse
                </div>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-6">
            <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                <div>
                    <h3 class="font-semibold text-gray-900">Riwayat Pendaftaran</h3>
                    <p class="text-xs text-gray-400 mt-0.5">Semua pendaftaran pada periode yang dipilih</p>
                </div>
                <span class="text-xs bg-purple-50 text-purple-600 border border-purple-100 px-3 py-1 rounded-full font-medium">
                    {{ $bookingDetails->total() }} pendaftaran
                </span>
            </div>
                ...
                <table class="min-w-full divide-y divide-gray-100">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-5 py-3 text-left text-xs font-semibold text-gray-500 uppercase">Tgl Daftar</th>
                            <th class="px-5 py-3 text-left text-xs font-semibold text-gray-500 uppercase">Tgl Event</th>
                        ...
                        <tr>
                            <td colspan="7" class="px-5 py-12 text-center">
                                <div class="flex flex-col items-center text-gray-400">
                                    <i class="fas fa-calendar-times text-3xl mb-2"></i>
                                    <p class="text-sm">Tidak ada pendaftaran pada periode ini</p>
                                </div>
                            </td>
                        </tr>
                        @endforelse
...
new Chart(statusCtx, {
    type: 'doughnut',
    data: {
        labels: ['Selesai', 'Terdaftar', 'Pending', 'Ditolak', 'Dibatalkan'],
        datasets: [{
            data: [
    ...
    options: {
        ...
        plugins: {
            ...
            tooltip: {
                callbacks: {
                    label: ctx => ctx.label + ': ' + ctx.parsed + ' pendaftaran',
                }
            }
        }
    }
