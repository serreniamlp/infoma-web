...
@section('title', 'Edit Produk - EduLiving')
...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-600 ml-7">Perbarui informasi produk kamu</p>
        </div>
        ...
        <form action="{{ route('user.marketplace.seller.update', $product) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <select id="status" name="status"
                                class="w-full px-4 py-2.5 border {{ $errors->has('status') ? 'border-red-400 bg-red-50' : 'border-gray-300' }} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors">
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="5"
                                  ...
                                  class="w-full px-4 py-2.5 border {{ $errors->has('description') ? 'border-red-400 bg-red-50' : 'border-gray-300' }} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors resize-none">{{ old('description', $product->description) }}</textarea>
                        @error('description')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-sm p-6 mb-6">
                ...
                <div id="upload-area"
                    ...
                    <p class="text-gray-400 text-sm mt-1">JPG, PNG, GIF • Maksimal 2MB per foto</p>
                </div>
