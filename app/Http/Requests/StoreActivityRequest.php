...
class StoreActivityRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'speakers.*.name.required_with' => 'Nama pemateri wajib diisi',
            'speakers.*.name.max'           => 'Nama pemateri maksimal 255 karakter',
            'speakers.*.title.max'          => 'Jabatan maksimal 255 karakter',
            'benefits.*.required_with'      => 'Isi benefit tidak boleh kosong',
            'benefits.*.max'                => 'Benefit maksimal 255 karakter',
        ];
    }
}
